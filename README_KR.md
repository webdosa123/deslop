...
| | 개별 점수 | 평균 |
|---|---|---|
| 🇰🇷 한국어, AI 같은 글 | 93, 89 | 91 |
| 🇰🇷 한국어, 사람 글 | 6, 0, 11 | 5.7 |
| 🇺🇸 영어, AI 같은 글 | 55, 75 | 64.9 |
| 🇺🇸 영어, 사람 글 | 0, 4 | 1.9 |

일부러 까다롭게 만든 샘플(언어당 35개씩, 마케팅·블로그·에세이·이메일·일기·리뷰에 더해 오탐을 노린 어휘 화려한 인간 글)로 넓게 재보면 AI 글 평균은 한국어 약 45, 영어 약 39이고 사람 글은 각각 약 10, 9다. 35점, 30점쯤 차이다. 두 언어 모두 사람 글 중 "AI 패턴 다수" 구간에 들어간 건 하나도 없다.
